...
struct Sizes {
  ...
  template <typename DenseIndex>
  constexpr EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE ptrdiff_t constexpr IndexOfColMajor(
  ...
  template <typename DenseIndex>
  constexpr EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE ptrdiff_t constexpr IndexOfRowMajor(
      const array<DenseIndex, Base::count>& indices) const {
